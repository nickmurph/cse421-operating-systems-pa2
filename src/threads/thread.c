               ...
               thread_func *function, void *aux) 
{
  ...
  child -> pid_child = t->tid;
  child -> child_thread = t;
  child -> exit = -500; // arbitrary placeholder number
...
//  fd_counter = 3;
// must be initalized to 3 because 0, 1, and 2 reserved for system. First fd number will be 3 and then increment from there
